...
public class OrderDTO extends Order{
    ...
    public boolean equals(Object o) {
        ...
        return price == orderDTO.price && quantity == orderDTO.quantity && Arrays.equals(imgs, orderDTO.imgs) && Objects.equals(deliveryman, orderDTO.deliveryman) && Objects.equals(userAddress, orderDTO.userAddress) && Objects.equals(createTimeStr, orderDTO.createTimeStr) && Objects.equals(pickupTimeStr, orderDTO.pickupTimeStr) && Objects.equals(finishedTimeStr, orderDTO.finishedTimeStr);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(deliveryman, userAddress, price, quantity, createTimeStr, pickupTimeStr, finishedTimeStr);
